...
<div class="main">
    ...
    %>
<div class="hotProd" style="width: 1280px; height: 500px; border: 3px solid #000; margin-left: 600px; margin-top: 50px; clear:both;">
	<div class="hotProdInfo" style="height: 100px; text-align: center;">HOT ITEM!</div>
...
<div class="test" id="tes" style="width: 300px; height: 300px; border: 3px solid #C5F">
<div class="newProd" style="width: 1280px; height: 500px; border: 3px solid #028; margin-left:600px; clear: both; margin-top:20px">
	<div class="newProdInfo" style="height: 100px; text-align: center;">NEW ITEM!</div>
